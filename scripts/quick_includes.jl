...
ffnet = loadFromNnet(args["nnet"], TanhActiv())
...
chordalsdp_opts = ChordalSdpOptions(mosek_opts=mosek_opts, verbose=true, two_stage_cliques=true)
...
nnet2onnx(rand_nnet, rand_onnx, ReluActiv())
